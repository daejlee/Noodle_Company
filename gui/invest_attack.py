...
#공격
# Load the UI file
Ui_Recommand, _ = uic.loadUiType("C:/Users/savif/workspace/Noodle_Company/gui/ui/attack_recommand.ui")

class attack(QtWidgets.QMainWindow, Ui_Recommand):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
