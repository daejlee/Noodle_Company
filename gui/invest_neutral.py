...
# 위험중립
# Load the UI file
Ui_Recommand, _ = uic.loadUiType("C:/Users/savif/workspace/Noodle_Company/gui/ui/risk_neutrality_recommand.ui")

class neutral(QtWidgets.QMainWindow, Ui_Recommand):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
